...
from .views import InboxView, GetMessages, SendMessages
# from .views import SendMessageView, InboxView, SingleMessageView

urlpatterns = [
    path("inbox/", InboxView.as_view(), name='inbox'),
    # path("inbox/<owner_id>/", InboxView.as_view(), name='inbox'),
    path("get-messages/<sender_id>/<recipient_id>/", GetMessages.as_view()),
